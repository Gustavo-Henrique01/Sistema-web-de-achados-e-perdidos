                    ...
                    <div class="card h-100 border-0">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="card-text">
                                    <span class="badge bg-{{ $item->status === 'em_transferencia' ? 'warning' : ($item->status === 'em_estabelecimento' ? 'info' : 'success') }}">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    @endif
                    <a href="/chatify/{{ $item->usuario->id }}" class="btn btn-success btn-sm mt-2">
